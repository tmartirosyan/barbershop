$(document).ready(function () {
  ...
  $("#registerDateDay").on("change", function () {
    let registerHairdressValue = $("#registerHairdress option:selected").val();
    let registerDateDayValue = $("#registerDateDay").val();
  ...
  function getAllDataText() {
    ...
    allData["dateDay"] = $("#registerDateDay").val();
  ...
  function getAllDataValue() {
    let selected = $("#registerHairCut option:selected"),
      ...
      registerDateDay = $("#registerDateDay"),
    ...
    if (!registerDateDay.val() || registerDateDay.val() == "hidden") {
